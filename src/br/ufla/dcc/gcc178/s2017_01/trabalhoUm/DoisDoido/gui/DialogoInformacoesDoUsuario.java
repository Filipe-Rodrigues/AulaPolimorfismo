...
public class DialogoInformacoesDoUsuario extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogoInformacoesDoUsuario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogoInformacoesDoUsuario dialog = new DialogoInformacoesDoUsuario(new Usuario("Teste", "AAA"), new JanelaNovoJogo(), true);
